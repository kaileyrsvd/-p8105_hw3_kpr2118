...
are generally between -15 to +30 (C) and that snowfall tends to be
seasonal with most of the snowfall is generally has the largest values
around 1 - 35mm, 50mm, and 75mm. We can also see outliers in temp min
and max and see the year to year changes in snowfall.
