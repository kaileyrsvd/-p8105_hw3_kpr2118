...
From this plot we can see how many items were ordered in each aisle... arranged by asile with the least to the most items ordered. We can tell things such as, butter is ordered the least and fresh vegetables and fruits are ordered significantly more than other items. 
