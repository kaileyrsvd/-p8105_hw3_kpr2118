...
In the plots above, we can see the tmax vs. tmin for the full dataset and the distribution of snowfall for values 0-100, by year. The plots allow us to visualize these aspects. We can see that the temperatures are generally between -15 to +30 (C) and that snowfall tends to be seasonal with most of the snowfall is generally has the largest values around 1 - 35mm, 50mm, and 75mm. We can also see outliers in temp min and max and see the year to year changes in snowfall. 
